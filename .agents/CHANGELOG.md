...
### 2026-08-08 — [agent] Establish collaboration contract
- Commit: `f8d26d4`
- Branch: `main`
...
### 2026-08-09 — [agent] Research public DIT skills and tools
- Commit: `uncommitted`
...
### 2026-08-09 — [agent] Research GP-M325F Silverstack Lua label printing
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Analyze DIT-Agent camera detection
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Add manual media suffix selection
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Exclude Apple Disk Image Media
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Bind PDF language to the application language
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Classify zero-missing verification and gate PDF association detail
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Add DIT Printer and ParaShoot Verify erase bridge
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Add XML-first Sony model identification
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Complete 1.1 remount flow and Printer audit interface
- Commit: `2c9f72d`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Require universal Developer ID notarized releases
- Commit: `f13014a`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Correct About copy and document ARRI Reference Tool CMD
- Commit: `2270cf4`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Add explicit ad-hoc GitHub prerelease flow
- Commit: `eca1ba1`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] License DIT Renamer under Apache-2.0
- Commit: `a89e5a6`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-09 — [agent] Streamline public docs and mark v1.1.0 latest
- Commit: `59a0962`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-10 — [agent] Research in-app online updates
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-10 — [agent] Implement free Sparkle update mode
- Commit: `uncommitted`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-10 — [agent] Finish 1.1.1 update release preparation
- Commit: `b28682e`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-10 — [agent] Add bilingual public documentation and DMG install shortcut
- Commit: `5107187`
- Branch: `codex/swift-1.1-hardening`
...
### 2026-08-10 — [agent] Publish 1.1.1 and signed appcast
- Commit: `pending`
- Branch: `codex/swift-1.1-hardening`
...
- Validation: README contains no Codex reference; tracked source text contains no literal `[codex]`; current branch is `main`; full application regression checks were already passed before this documentation-only change.
- Follow-up/risk: Existing immutable Git history and the retained local baseline branch are not rewritten. The remote legacy branch can be removed later if desired, but the public default is `main`.
