...
- Status: Swift 1.1 hardening and release integration in progress; DIT Printer remains a separately built extension and is not included in the 1.1 app package
...
- Latest validation: Swift typecheck, build script syntax check, `git diff --check`, and 1.1 app/zip/DMG build passed.
