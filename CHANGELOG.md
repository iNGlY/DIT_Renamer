...
- 增加卷名 suffix 是否保留的手动选择，并继续执行 exFAT/FAT/MS-DOS 11 字符限制。
- 保持 Apple Disk Image Media、网络卷和系统虚拟卷硬过滤。
...
- Added a manual choice for retaining a detected volume-name suffix, while preserving the 11-character exFAT/FAT/MS-DOS limit.
